...
ISR(TIMER0_COMPA_vect){
	++ms;     // -------------------------------- ako ++ms stavimo prije if-a motor ce se poceti okretati tek nakon 2 sekunde (zbog uvijeta u if-u)
	if(ms % delay_msec == 0){ //----------------- ako pak stavimo nakon prvog if-a motor se okrece odmah (ms je 0 pa odmah upadne u if)
